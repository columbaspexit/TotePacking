...
# This encodes which coordinate,for each pair of coordinates, spans tote
diff_tess <- array(# rem-x  rem-y rem-z
  c(0,0,0, 1,0,0, 0,0,0, # The rem-x prism spans its NEXT dim, toteW
    0,1,0, 0,0,0, 0,0,0, # The rem-y prism spans its PREVIOUS dim, toteL
    
    0,0,0, 0,0,0, 0,1,0, # The rem-y prism spans its NEXT dim, toteH
    0,0,0, 0,0,1, 0,0,0, # The rem-z prism spans its PREVIOUS dim, toteW
    
    0,0,1, 0,0,0, 0,0,0, # The rem-z prism spans its NEXT dim, toteL
    0,0,0, 0,0,0, 1,0,0) # The rem-x prism spans its PREVIOUS dim, toteH
